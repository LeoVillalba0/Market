define(['angular'], function() {
    var production = {
                        ...
                        if (game.production.alert[i] == false) {
                            if (sold > canSell) {
                                ...
                                if (game.production.alert[i] == "notify") {
                                    ...
                                    $(drugStockName).addClass("alert-danger");
                                };
                            };
                            if (sold <= canSell) {
                                gain = (sold * drugPrice);
                            ...
                            if (sold <= canSell) {
                                ...
                                $(drugStockName).removeClass("alert-danger");
                            };
                        };
                    };
                };
        ...
        getDrugReward: function(drugIndex) {
            return ((this.prices[drugIndex] * this.multipliers[drugIndex]) * this.totalRewardMultiplier);
        },
