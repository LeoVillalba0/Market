    ...
    var collections = {
        ...
        varInit: function() {
            ...
            this.list[0] = new Array(
                new this.create("Gun I-I", 0, 0, "+2% money reward +2% rep. reward</span>", "totalRewardMultiplier", "*1.02", "totalReputationMultiplier", "*1.02"),
                new this.create("Gun I-II", 0, 0, "+3% money reward +3% rep. reward</span>", "totalRewardMultiplier", "*1.03", "totalReputationMultiplier", "*1.03"),
                new this.create("Gun I-III", 0, 0, "+5% money reward +5% rep. reward</span>", "totalRewardMultiplier", "*1.05", "totalReputationMultiplier", "*1.05"),
            ...
            this.list[1] = new Array(
                new this.create("Gun II-I", 1, 0, "+6% money reward +6% rep. reward", "totalRewardMultiplier", "*1.06", "totalReputationMultiplier", "*1.06"),
                new this.create("Gun II-II", 1, 0, "+7% money reward +7% rep. reward", "totalRewardMultiplier", "*1.07", "totalReputationMultiplier", "*1.07"),
                new this.create("Gun II-III", 1, 0, "+8% money reward +8% rep. reward", "totalRewardMultiplier", "*1.08", "totalReputationMultiplier", "*1.08"),
            ...
            this.list[2] = new Array(
                new this.create("Gun III-I", 2, 0, "+9% money reward +9% rep. reward", "totalRewardMultiplier", "*1.09", "totalReputationMultiplier", "*1.09"),
                new this.create("Gun III-II", 2, 0, "+10% money reward +10% rep. reward", "totalRewardMultiplier", "*1.10", "totalReputationMultiplier", "*1.10"),
                new this.create("Gun III-III", 2, 0, "+11% money reward +11% rep. reward", "totalRewardMultiplier", "*1.11", "totalReputationMultiplier", "*1.11"),
            ...
            this.list[3] = new Array(
                new this.create("Gun IV-I", 3, 0, "+12% money reward +12% rep. reward", "totalRewardMultiplier", "*1.12", "totalReputationMultiplier", "*1.12"),
                new this.create("Gun IV-II", 3, 0, "+13% money reward +13% rep. reward", "totalRewardMultiplier", "*1.13", "totalReputationMultiplier", "*1.13"),
                new this.create("Gun IV-III", 3, 0, "+14% money reward +14% rep. reward", "totalRewardMultiplier", "*1.14", "totalReputationMultiplier", "*1.14"),
